        ...
        <e.AccountsContent>
            ...
            business.map((usr,KEY)=>{
                ...
                <e.AccountCard key={KEY}>
                    ...
                    <e.AccountCardBanner source={require(`../.files/database/default-personal-banner.png`)} /> : null}
                    {usr.business_pic === 'default-personal-pic.png' ? 
                    <e.AccountCardPic source={require(`../.files/database/default-personal-pic.png`)} /> : null}
