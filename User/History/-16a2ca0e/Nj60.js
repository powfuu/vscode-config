        ...
        <e.AccountsContent>
            ...
            business.map((usr,KEY)=>{
                ...
                <e.AccountCard key={KEY}>
                    ...
                    <e.AccountCardBanner source={require(`../.files/database/default-business-banner.png`)} /> : null}
                    {usr.business_pic === 'default-business-pic.png' ? 
                    <e.AccountCardPic source={require(`../.files/database/default-business-pic.png`)} /> : null}
