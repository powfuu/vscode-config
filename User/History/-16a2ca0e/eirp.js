...
return(
  ...
  <e.PreferencesPopup>
            <e.SearchView>
            <e.SearchIc name="search" size={24} color="#666"/>
 ...
 <e.PreferencesPopupDescriptionView><e.PreferencesPopupDescription>You are searching for: </e.PreferencesPopupDescription>
                ...
                <e.PreferencesPopupPreferences>{prefs.searchingfor1}</e.PreferencesPopupPreferences>
        ...
        <e.AccountsContent>
            ...
            business.map((usr,KEY)=>{
                ...
                <e.AccountCard key={KEY}>
                    <e.AccountCardName>{usr.email}</e.AccountCardName>
                </e.AccountCard>
                )
            }) : users.map((usr,KEY)=>{
                return(
