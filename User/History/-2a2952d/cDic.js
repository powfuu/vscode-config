    ...
    return( 
        <Tab.Navigator initialRouteName='Dashboard' 
         screenOptions={{
            ...
            <Tab.Screen name="Account" component={Account} options={{tabBarVisible: false, tabBarIcon: ()=> null}} name="Account"/>
             <Tab.Screen options={{tabBarVisible: false, tabBarIcon: ()=> null}} name="myAccount" component={MyAccount}/>
        </Tab.Navigator>
    )
}
