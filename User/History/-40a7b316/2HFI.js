...
export default function BottomNav({navigation}){
    ...
    return(
        <MainViewBottomNav>
            <e.NavIcon name="dashboard" size={26} color={activeIco} />
            <e.NavIcon name="chat" size={24} color={inactiveIco} />
            <e.NavIcon name="explore" size={26} color={inactiveIco} />
            <e.NavIcon name="notifications" size={26} color={inactiveIco} />
