...
export default function BottomNav({navigation}){
    ...
    return(
        <MainViewBottomNav>
            <e.NavIcon name="dashboard" size={25} color={activeIco} />
            <e.NavIcon name="chat" size={23} color={inactiveIco} />
            <e.NavIcon name="explore" size={25} color={inactiveIco} />
            <e.NavIcon name="notifications" size={25} color={inactiveIco} />
            <e.NavIcon name="menu" size={29} color={inactiveIco} />
        </MainViewBottomNav>
    )
