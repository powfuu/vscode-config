            ...
            <e.AccountInitialSection> 
                ...
                <e.AccountName>{ddname}</e.AccountName>
                 <e.AccountProfessionView> 
                   <e.AccountProfession>{data.profession}  {starVal >= 0 ? <e.AccountProfessionStar name="star" size={11.6} color="gold"/> : null} <e.StarVal>{starVal}</e.StarVal></e.AccountProfession> 
