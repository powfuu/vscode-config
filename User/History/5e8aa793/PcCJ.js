...
const Dashboard = ({navigation}) =>{
 ...
 const fadeOut = (prop) =>{
  ...
  return (
      <e.MainView>
          <e.LogoView>
<Animated.View animation="fadeInUp"><e.Logo name="hands-helping" size={27} color="white" />
</Animated.View>
<Animated.View animation="fadeInUp"><e.LogoText>Support Decisions</e.LogoText></Animated.View>
